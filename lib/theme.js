export function getTheme(darkMode) {
  return darkMode
    ? {
        ...
        altBg: "bg-[linear-gradient(180deg,#060606,#0d0d0d)]",
        input: "border-white/10 bg-[#f5f1e8] text-black placeholder:text-black/60 focus:border-[#22c55e]",
      }
    : {
        ...
        cardHover: "hover:border-[#8fd1a8] hover:bg-[#e4f5ea]",
        buttonGhost:
        ...
        textMain: "text-[#08110c]",
        menuLink: "text-[#102018] hover:text-[#16a34a]",
        heroOverlay:
          "bg-[linear-gradient(90deg,rgba(244,251,246,0.72)_0%,rgba(244,251,246,0.60)_42%,rgba(244,251,246,0.18)_100%)]",
        ...
        altBg: "bg-[#f8fff9]",
        input: "border-black/10 bg-white text-black placeholder:text-black/50 focus:border-[#22c55e]",
      };
}