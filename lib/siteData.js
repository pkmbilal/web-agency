...
export const productProcess = [
  {
    step: "01",
    title: "Discover",
    text: "We learn about your goals, audience, and product direction to build a clear foundation for the project.",
  },
  {
    step: "02",
    title: "Plan",
    text: "We define the structure, priorities, and user flow so the product feels organized before design and development begin.",
  },
  {
    step: "03",
    title: "Build",
    text: "We design and develop the product with attention to usability, responsiveness, and a polished visual experience.",
  },
  {
    step: "04",
    title: "Refine",
    text: "We review the final experience, make improvements, and prepare everything for a smooth launch.",
  },
];
...
export const productStats = [
  {
    title: "Modern UI",
    value: "100%",
    description: "Clean, premium, and responsive interfaces built for trust.",
    icon: Palette,
  },
  {
    title: "Fast Delivery",
    value: "Quick",
    description: "Streamlined workflows that keep projects moving efficiently.",
    icon: Zap,
  },
  {
    title: "Scalable Build",
    value: "Future",
    description: "Products structured to support growth and easy expansion.",
    icon: Layers3,
  },
  {
    title: "Reliable Quality",
    value: "Strong",
    description: "Built with attention to detail, usability, and consistency.",
    icon: ShieldCheck,
  },
];
...
export const productCategories = [
  {
    ...
    description:
      "Professional websites built to strengthen credibility and support lead generation.",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80",
    points: [
  ...
  },
  {
    title: "Landing Pages",
    description:
      "High-converting landing pages designed for campaigns, launches, and paid traffic.",
    image:
  ...
  },
  {
    ...
    description:
      "Modern storefronts that present products clearly and improve the buying experience.",
    image:
  ...
  },
  {
    ...
    description:
      "Custom platforms and dashboards tailored for business operations and digital services.",
    image:
  ...
  },
  {
    ...
    description:
      "Elegant showcase websites for agencies, studios, and brands that want a premium look.",
    image:
      "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1200&q=80",
    points: [
  ...
  },
  {
    ...
    description:
      "Tailored digital products built around your workflow, business model, and goals.",
    image:
...
export const productFaqs = [
  {
    ...
    answer:
      "We build business websites, landing pages, ecommerce experiences, and custom web-based digital products tailored to business goals.",
  },
  {
    question: "Can you build custom products based on my requirements?",
    answer:
      "Yes. We can shape the product structure, design, and functionality around your specific business needs.",
  },
  {
    question: "Do your products work well on mobile devices?",
    answer:
      "Yes. Every product is designed to be responsive and usable across mobile, tablet, and desktop screens.",
  },
  {
    question: "Can you redesign an existing product or website?",
    answer:
      "Yes. We can refresh the design, improve the layout, and rebuild the experience with a more modern and effective approach.",
  },
];
