...
export const portfolioFaqs = [
  {
    question: "Can I show portfolio even if I have limited real client work?",
    answer:
      "Yes. You can show concept projects, redesign samples, and presentation-ready case studies, but do not falsely claim another developer’s work as your own.",
  },
  {
    question: "Can this portfolio page be used for a web agency?",
    answer:
      "Yes. This layout is suitable for a web design, development, branding, or digital service agency.",
  },
  {
    question: "Can I link each project to a detailed page?",
    answer:
      "Yes. Each card already includes a link field, so you can connect it to a detailed case study page later.",
  },
  {
    question: "Is this mobile responsive?",
    answer:
      "Yes. The layout is built with responsive Tailwind classes for mobile, tablet, and desktop.",
  },
];
