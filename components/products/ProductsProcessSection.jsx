...
export default function ProductsProcessSection({
  darkMode,
  theme,
  fadeUp,
  productProcess,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            A simple workflow that keeps product delivery clear and efficient.
          </h2>
        </motion.div>
            ...
            >
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p
                    className={`mt-3 text-base leading-7 ${theme.textSecondary}`}
                  >
                    {item.text}
                  </p>
                </div>
