      ...
      <div className="w-full">
        ...
        >
          ...
          <h2 className={`text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl ${theme.textPrimary}`}>
            Experience, reach, and consistent delivery.
          </h2>
        </motion.div>
        ...
        >
          {aboutStats.map((item) => {
            ...
            return (
              ...
              >
                <div className={`inline-flex w-fit rounded-2xl border p-3 transition-all duration-300 ${theme.softPanel} group-hover:border-[#22c55e]/35 group-hover:bg-[#22c55e]/10`}>
